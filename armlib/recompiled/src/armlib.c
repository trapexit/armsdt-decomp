...
char * FUN_0804b900(char *param_1,void *param_2,void **param_3);
char * FUN_0804b950(void **param_1);
void FUN_0804b998(void **param_1);
bool FUN_0804ba90(char *param_1,char *param_2);

static void func_0x00000000(void)
...
void __register_frame_info(void *param_1,void *param_2)
...
void __deregister_frame_info(void *param_1)
...
void processEntry_entry(undefined4 param_1,undefined4 param_2)

{
  (void)param_1;
  (void)param_2;
  __libc_start_main(FUN_0804a988,0,(char **)0,_DT_INIT,_DT_FINI,0,(void *)0);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  *puVar6 = 0;
  ...
  DAT_0804d7d0 = puVar2;
  DAT_0804d7d4 = (undefined4 **)puVar6;
  return;
}
      ...
      for (; puVar10 < puVar6; puVar10 = (uint *)((int)puVar10 + uVar5)) {
        if (*puVar10 != 0) {
          ...
          if (iVar7 == 0) {
            ...
            uVar8 = FUN_0804ac1c(*(uint *)(pbVar4 + uVar8 * 0x10 + 0x18));
            bVar3 = true;
            if (DAT_0804d834 != 3) {
      ...
      if (pbVar3 == (byte *)0x0) {
        ...
        do {
          ...
          if (lVar4 < 0) {
            ...
            FUN_08049290(pbVar3,(undefined4)__dest,0,lVar4,(undefined4)&DAT_0804d7c0);
            FUN_080494c0(pbVar3);
          }
  ...
  if (DAT_0804d850 != 0) {
    ...
    for (; puVar5 < puVar4; puVar5 = (uint *)((int)puVar5 + uVar2)) {
      if (*puVar5 != 0) {
        ...
        uVar2 = FUN_0804ac1c(*(uint *)(pbVar1 + uVar2 * 0x10 + 0x18));
...

{
  ...
  do {
    ...
    if (*param_1 == 0x2d) {
      while (param_1 = param_1 + 1, puVar2 = DAT_0804d7c8, puVar3 = (undefined4 *)DAT_0804d7cc,
            *param_1 != 0) {
...
LAB_0804a5ba:
      ...
      DAT_0804d644 = 1;
      puVar2 = DAT_0804d7c8;
      puVar3 = (undefined4 *)DAT_0804d7cc;
    }
    else {
      uVar8 = 0xffffffff;
      pbVar5 = param_1;
    ...
    DAT_0804d7cc = (undefined4 **)puVar3;
    DAT_0804d7c8 = puVar2;
    bVar1 = *local_8;
    param_1 = local_8;
  } while( true );
...

{
  ...
  *(undefined1 *)(param_2 + 5) = 0;
  ...
  if ((cVar4 == '\\') && (param_1[1] == '\\')) {
    ...
    *(char *)(param_2 + 4) = (char)(pcVar3 - (char *)*param_2);
    param_1 = pcVar3;
  }
  else {
...
{
  if ((param_1 != (void **)0x0) && ((DIR *)param_1[0] != (DIR *)0x0)) {
    closedir((DIR *)param_1[0]);
  }
  return;
}
