...
- [The ARM procedure call standard](https://ext.3dodev.com/3DO/Portfolio_2.5/OnLineDoc/DevDocs/tktfldr/atsfldr/4atsa.html#XREF17932)
- [APCS variants](https://ext.3dodev.com/3DO/Portfolio_2.5/OnLineDoc/DevDocs/tktfldr/atsfldr/4atsb.html#XREF35590)
- [C language calling conventions](https://ext.3dodev.com/3DO/Portfolio_2.5/OnLineDoc/DevDocs/tktfldr/atsfldr/4atsc.html#XREF36070)
- [Some examples](https://ext.3dodev.com/3DO/Portfolio_2.5/OnLineDoc/DevDocs/tktfldr/atsfldr/4atsd.html#XREF14949)
- [The APCS in non-user ARM modes](https://ext.3dodev.com/3DO/Portfolio_2.5/OnLineDoc/DevDocs/tktfldr/atsfldr/4atse.html#XREF36256)
...
| sl/v7 | 10     | stack limit / stack chunk handle / register variable |
| fp    | 11     | frame pointer                                        |
...
across a function call. In 26-bit ARM modes, the caller's PSR flags are 
naturally reinstated when the return link pointer is placed in pc. Note 
that the N, Z, C and V flags from lr at the instant of entry must be 
reinstated; it is not sufficient merely to preserve the PSR across the 
call. Consider, a function `ProcA` which tail continues to `ProcB` as follows:
